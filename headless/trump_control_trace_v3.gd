...
#
# Run:
#   "$GODOT" --headless --path . --script res://headless/trump_control_trace_v3.gd
# ═══════════════════════════════════════════════════════════════════
...
func _init():
	...
	var f = FileAccess.open("res://headless/trump_control_trace_v3_results.json", FileAccess.WRITE)
	f.store_string(JSON.stringify(out, "\t"))
	f.close()

	print("")
	print("Results written to res://headless/trump_control_trace_v3_results.json")
	quit(0)
