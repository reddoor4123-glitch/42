...
#
# Run:
#   "$GODOT" --headless --path . --script res://headless/hand_ends_early_points_trace.gd
# ═══════════════════════════════════════════════════════════════════════════
...
func _init():
	...
	var f = FileAccess.open("res://headless/hand_ends_early_points_trace_results.json", FileAccess.WRITE)
	f.store_string(JSON.stringify(output, "\t"))
	f.close()

	print("")
	print("Results written to res://headless/hand_ends_early_points_trace_results.json")
