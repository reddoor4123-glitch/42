...
#
# Run:
#   "$GODOT" --headless --path . --script res://headless/preset_persistence_trace.gd
# ═══════════════════════════════════════════════════════════════════
...
func _init():
	...
	var out_f = FileAccess.open("res://headless/preset_persistence_trace_results.json", FileAccess.WRITE)
	...
	print("")
	print("Results written to res://headless/preset_persistence_trace_results.json")
