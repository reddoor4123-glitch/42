...
#
# Run:
#   "$GODOT" --headless --path . --script res://headless/player_profile_trace.gd
# ═══════════════════════════════════════════════════════════════════
...
func _init():
	...
	var out_f = FileAccess.open("res://headless/player_profile_trace_results.json", FileAccess.WRITE)
	...
	print("")
	print("Results written to res://headless/player_profile_trace_results.json")
