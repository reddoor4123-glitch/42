...
#
# Run:
#   "$GODOT" --headless --path . --script res://headless/laydown_game_functions_trace.gd
# ═══════════════════════════════════════════════════════════════════════════
...
func _init():
	...
	var f = FileAccess.open("res://headless/laydown_game_functions_trace_results.json", FileAccess.WRITE)
	f.store_string(JSON.stringify(output, "\t"))
	f.close()

	print("")
	print("Results written to res://headless/laydown_game_functions_trace_results.json")
