...
#
# Run:
#   "$GODOT" --headless --path . --script res://headless/set_vs_make_path_b_trace.gd
# ═══════════════════════════════════════════════════════════════════
...
func _init():
	...
	var f = FileAccess.open("res://headless/set_vs_make_path_b_trace_results.json", FileAccess.WRITE)
	f.store_string(JSON.stringify(results, "\t"))
	f.close()

	print("")
	print("Results written to res://headless/set_vs_make_path_b_trace_results.json")
	quit(0)
