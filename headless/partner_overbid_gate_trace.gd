...
#
# Run:
#   "$GODOT" --headless --path . --script res://headless/partner_overbid_gate_trace.gd
# ═══════════════════════════════════════════════════════════════════
...
func _init():
	...
	var f = FileAccess.open("res://headless/partner_overbid_gate_trace_results.json", FileAccess.WRITE)
	f.store_string(JSON.stringify(out, "\t"))
	f.close()

	print("")
	print("Results written to res://headless/partner_overbid_gate_trace_results.json")
