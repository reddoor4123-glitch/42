...
#
# Run:
#   "$GODOT" --headless --path . --script res://headless/trump_control_trace_v2.gd
# ═══════════════════════════════════════════════════════════════════
...
func _init():
	...
	var f = FileAccess.open("res://headless/trump_control_trace_v2_results.json", FileAccess.WRITE)
	f.store_string(JSON.stringify(results, "\t"))
	f.close()

	print("")
	print("Results written to res://headless/trump_control_trace_v2_results.json")
	quit(0)
